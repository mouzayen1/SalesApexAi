...
export interface LenderTierPricing {
  ...
  buyRate: number;    // Base rate lender charges dealer
  maxMarkup: number;  // Max dealer markup allowed above buy rate
}
...
export interface LenderConfig {
  ...
  dealerReserveSplit: number; // Dealer's share of reserve (e.g., 0.7 = 70%)
